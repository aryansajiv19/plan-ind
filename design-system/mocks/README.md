...
| `punch-v1.html` | Does one saturated warm accent add the missing energy? | **Live — specced as §27.** `#C34A2D`, fill only. Also where the ambient-eats-the-boundary interaction and the accent/error collision were found. |
| `social-dubai-v1.html` | How does it read social, fun and Dubai with no photos and no new colour? | **Live — specced as §26.** Ambient light, held seats, the 23-category field, and the finished type scale. |
