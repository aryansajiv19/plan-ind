...
-- Who can call these: signed-in sessions. (064, below, refuses anonymous ones.)
...
-- 064: plan participants must hold a permanent account (owner decision
-- 2026-09-25). Anonymous sessions can no longer claim, vote, reply, rate,
-- unrate, leave, or read anything plan-scoped. Existing guest rows are kept
-- and inert. See supabase/migration-064-signed-in-participants.sql.
