...
Cohesion: 0.06
Nodes (40): APP_VIEWS, AppView, HomePage(), AVATAR_COLORS, AVATAR_EMOJI, cacheMe(), DeviceProfile, getMe() (+32 more)

### Community 3 - "StartPlanForm.tsx"
Cohesion: 0.06
Nodes (44): PlaceLinkImporter(), SavedLink, BUDGETS, CATEGORIES, Category, CATEGORY_GROUPS, CategoryKey, GroupKey (+36 more)
...
### Community 10 - "AccountViews.tsx"
Cohesion: 0.18
Nodes (14): AccountView, AccountViews(), DATE_FORMAT, PlaceCard(), priceLabel(), OptionCard(), OptionCardProps, avatarHue() (+6 more)

### Community 11 - "Supabase Auth Setup"
Cohesion: 0.12
Nodes (17): 1. Apply the database migration, 2. Configure email one-time codes, 3. Configure Google, 4. Allow application redirects, 5. Environment variables, Email One-Time Code Sign-In, Public Supabase Environment Shape, Google OAuth Provider Config (+9 more)

### Community 12 - "4. What to build next, in this order"
Cohesion: 0.12
...
Cohesion: 0.20
Nodes (10): Access, closesLabel(), Load, VotePage(), NameGateProps, addBeen(), participantTokenHash(), randomToken() (+2 more)

### Community 15 - "plan-ind Working Checkpoint"
Cohesion: 0.14
...
### Community 16 - "Resolution pipeline to build next"
Cohesion: 0.14
...
### Community 17 - "Security Hardening Pass 2026-08-10"
Cohesion: 0.26
Nodes (13): Age-Aware Mainstream Catalog, Host-Token Plan Commands, Participant Write RPCs, Secure Server-Side Plan Creation, Security Review P0/P1 Findings, Host Token Isolation (plan_host_tokens), Legacy Direct-Write Path Removal, Write-Once member_ages DOB Record (+5 more)

### Community 18 - "Product Strategy: The Group Decision Layer for Going Out"
Cohesion: 0.15
...
### Community 19 - "HomeExperience.tsx"
Cohesion: 0.24
Nodes (8): APP_VIEWS, AppView, DECISION_ROWS, greetingFor(), HomeExperience(), VIEW_LABELS, viewFromParam(), haptic()

### Community 20 - "Competitive landscape"
Cohesion: 0.17
...
### Community 21 - "Frontend Design Standards"
Cohesion: 0.24
Nodes (10): Next.js Breaking-Changes Rule, Targeted Graphify Feature Workflow, Verification Without a Test Runner, Components, Frontend Design Standards, Layout, Motion, Typography (+2 more)

### Community 22 - "Progressive Pools Plan Format"
Cohesion: 0.18
Nodes (11): Migration 007 Auth Binding, No Legacy Identity Claim, Progressive Pools Plan Format, Related-Category Dealing Fallback, RSVP Coming / Maybe / Can't Make It, Saved Custom Places, Source Freshness and Claim Separation, Better Decision Protocol (+3 more)

### Community 23 - "Luna Smart Search"
Cohesion: 0.22
Nodes (11): Budget, Origin and Radius Inputs, Luna Smart Search, Multidimensional Place Taxonomy, Implementation quality, Strategy Anti-Patterns, Constraint-Aware Three, Never a Feed, Recommended Delivery Order, Group Decision Layer Positioning (+3 more)

### Community 24 - "Seven-Stage Resolution Pipeline"
Cohesion: 0.27
...
### Community 26 - "backend-data Agent"
Cohesion: 0.29
Nodes (11): backend-data Agent, frontend Agent, qa-test Agent, Silent Correctness Failure (a wrong winner throws no error), plan-ind Agent Team (four subagents + orchestrator), File Ownership Map, Default Handoff Flow (backend-data to security to frontend to qa-test), Attacker-Supplied Input Rendered to the Group (+3 more)

### Community 27 - "Four-Table Schema (spots, plans, plan_spots, votes)"
Cohesion: 0.28
...
### Community 28 - "plan-ind Invariants"
Cohesion: 0.22
...
### Community 33 - "Low-Friction Product Promise (no signup, link in a group chat)"
Cohesion: 0.18
Nodes (11): Create - Share - Vote - Live Tally - Decided Flow, Low-Friction Product Promise (no signup, link in a group chat), Mobile-First 375px and A11y Baseline, Persist voter_name Locally (never ask a returning voter twice), Copyable Share Link as the Growth Loop, E2E Two-Browser-Context Share-Link Flow, Parallel Sessions Share Only the Repo, Commit Early (parallel-session safety rule) (+3 more)

### Community 34 - "Visual direction"
Cohesion: 0.29
...
### Community 37 - "Browser Realtime Subscription (votes, plans; removeChannel on unmount)"
Cohesion: 0.29
...
## Knowledge Gaps
- **228 isolated node(s):** `NameGateProps`, `eslintConfig`, `AVATAR_COLORS`, `AVATAR_EMOJI`, `AREA_CENTRES` (+223 more)
...
- **What is the exact relationship between `Alcohol Signal: Red Wine Served at Table` and `Demo Asset Role: Hero Dinner Imagery for Demo Account Views`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `createClient()` connect `createClient` to `supabase.ts`, `social.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `plans` connect `schema.sql` to `migration-020-production-security.sql`, `migration-005-social.sql`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Product Strategy: The Group Decision Layer for Going Out` connect `Product Strategy: The Group Decision Layer for Going Out` to `Competitive landscape`, `Cross-Platform Architecture`, `Luna Smart Search`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
